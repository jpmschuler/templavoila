...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addUserTSConfig('<INCLUDE_TYPOSCRIPT: source="FILE:EXT:' . $_EXTKEY . '/Configuration/TSConfig/User.ts">');
...
$GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['lowlevel']['cleanerModules']['tx_templavoila_unusedce'] = array(
    'EXT:templavoila/Classes/Comand/UnusedContentElementComand.php:Extension\Templavoila\Comand\UnusedContentElementComand'
);
$GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['l10nmgr']['indexFilter']['tx_templavoila_usedCE'] = array(
    'EXT:templavoila/Classes/Service/UserFunc/UsedContentElement.php:Extension\Templavoila\Service\UserFunc\UsedContentElement'
);
